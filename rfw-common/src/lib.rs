...
pub const RULE_BLOCK_HYSTERIA2: u32 = 1 << 11; // Block Hysteria2/HY2 inbound traffic
pub const RULE_BLOCK_TUIC: u32 = 1 << 12; // Block TUIC inbound traffic
pub const RULE_BLOCK_UDP_FET: u32 = 1 << 13; // Block UDP fully encrypted traffic
pub const RULE_BLOCK_VLESS_TCP: u32 = 1 << 14; // Block raw VLESS over TCP inbound traffic
pub const RULE_BLOCK_VMESS_TCP: u32 = 1 << 15; // Block raw VMess over TCP inbound traffic
